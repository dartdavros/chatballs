...
- **KB8 Импорт YAML** — разбор до применения: файл, сводка «создать 4 / обновить 2 / ошибка 1», таблица документ · `categoryPath` · действие · замечание; ошибочная строка красная с текстом «категории нет — импорт не создаёт категории»; primary «Импортировать 6 документов».
