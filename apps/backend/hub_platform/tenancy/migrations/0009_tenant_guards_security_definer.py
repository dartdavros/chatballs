...
выставленного `custocrm.organization_id` (outbox-воркер claim'ит событие
...
SECURITY DEFINER исполняет их от custocrm_schema (policy USING (true)),
