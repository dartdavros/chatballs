...
FORWARD_SQL = """
ALTER TABLE tenancy_storagereservation OWNER TO custocrm_schema;
...
GRANT SELECT, INSERT, UPDATE, DELETE
    ON tenancy_storagereservation TO custocrm_runtime_app;
GRANT ALL ON tenancy_storagereservation TO custocrm_schema;
GRANT USAGE, SELECT ON SEQUENCE tenancy_storagereservation_id_seq
    TO custocrm_runtime_app, custocrm_schema;

DROP POLICY IF EXISTS custocrm_tenant_isolation ON tenancy_storagereservation;
CREATE POLICY custocrm_tenant_isolation ON tenancy_storagereservation
...
DROP POLICY IF EXISTS custocrm_schema_access ON tenancy_storagereservation;
CREATE POLICY custocrm_schema_access ON tenancy_storagereservation
...
REVOKE ALL ON tenancy_storagereservation FROM custocrm_runtime_app;
