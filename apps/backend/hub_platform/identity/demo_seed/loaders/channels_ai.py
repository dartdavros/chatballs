...
from hub_platform.ai.knowledge_categories import create_category, ensure_uncategorized_category
...
from hub_platform.identity.demo_seed.loaders.common import backdate, now, rng
...
def _ensure_categories(context: TenantContext, refs: DemoRefs, items: list[dict], *, parent) -> None:
    from hub_platform.ai.knowledge_models import KnowledgeCategory
