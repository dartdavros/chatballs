...
import hub_platform.webchat.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("public_key", models.CharField(default=hub_platform.webchat.models.generate_widget_public_key, editable=False, max_length=64, unique=True)),
