...
def create_call_request(*, conversation_id: int, initiator: HumanUser):
    ...
    from chatballs.calls.services import create_call_request as create_with_context
...
def expire_stale_calls(organization: Organization) -> int:
    ...
    from chatballs.calls.maintenance import expire_stale_calls as expire_with_context
