...
class RuntimeSurfaceSettingsTests(SimpleTestCase):
    def test_cookie_names_are_isolated_and_host_only(self) -> None:
        surfaces = [
            import_module("chatballs_backend.settings_app"),
            import_module("chatballs_backend.settings_platform"),
            import_module("chatballs_backend.settings_admin"),
        ]
    ...
    def test_admin_hosts_are_loopback_only(self) -> None:
        admin_settings = import_module("chatballs_backend.settings_admin")
    ...
    def test_gateway_ask_endpoint_is_exempt_from_ssl_redirect(self) -> None:
        ...
        platform_settings = import_module("chatballs_backend.settings_platform")
