...
export function ProductsTable({ products, period, periodLabel, menuId, setMenuId, deactivate }: { products: Product[]; period: ProductPeriod; periodLabel: string; menuId: number | null; setMenuId: (id: number | null) => void; deactivate: (product: Product) => void }) {
  return (
