      ...
      <td className="row-actions">
        ...
        {menuOpen && (
          <div className="row-menu">
            ...
            <span />
            <button className={employee.isBlocked ? "success" : "danger"} onClick={() => block(employee)} disabled={employee.isBlocked || !(employee.permissions?.canBlock ?? false)}>{employee.isBlocked ? "Разблокировать" : "Заблокировать"}</button>
          </div>
        )}
      </td>
    </tr>
